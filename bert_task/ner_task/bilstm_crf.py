...
class BiLSTMCRF(object):
    def __init__(self, embedded_chars, hidden_sizes, layers, keep_prob, num_labels,
    ...
    def bi_lstms(self):
        ...
        with tf.name_scope("embedding"):
            self.embedded_chars = tf.nn.dropout(self.embedded_chars, keep_prob=self.keep_prob)
